...
const App = ({ contract, currentUser, nearConfig, wallet }) => {
  ...
  useEffect(() => {
    ...
    contract.get_num().then(setCounter);
  }, []);
  ...
  return (
    <main>
      <header>
        ...
        { currentUser
          ? <button onClick={incrementIn}>Increase Counter</button>
          : <SignIn/>
        }
        { currentUser
          ? <button onClick={decrementIn}>Decrease Counter</button>
          : <SignIn/>
        }
        </header>
        { currentUser
